  ...
  routes: [
    {
      ...
      meta: { title: "约跑后台管理", hidden: true, notNeedAuth: true }
    },
    {
      path: "/404",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: "event",
          component: () =>
            import(/* webpackChunkName: "shopTable" */ "@/views/event/index.vue"),
          meta: {
            title: "活动管理",
            icon: "icon-dish"
          }
        },
        {
          path: "challengePK",
          component: () =>
            import(/* webpackChunkName: "shopTable" */ "@/views/challengePK/index.vue"),
          meta: {
            title: "挑战PK",
            icon: "icon-dish"
          }
        },
        {
          path: "runTogether",
          component: () =>
            import(/* webpackChunkName: "shopTable" */ "@/views/runTogether/index.vue"),
          meta: {
            title: "约跑管理",
            icon: "icon-dish"
          }
