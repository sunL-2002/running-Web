<template>
  <div class="dashboard-container">
    <div class="container">
      <div class="tableBar">
        <label style="margin-right: 10px">发起人姓名：</label>
        <el-input v-model="input"
                  placeholder="请填写发起人名称"
                  style="width: 14%"
                  clearable
                  @clear="init"
                  @keyup.enter.native="initFun" />
        <label style="margin-right: 10px">接受人姓名：</label>
        <el-input v-model="input2"
                  placeholder="请填写接受人名称"
                  style="width: 14%"
                  clearable
                  @clear="init"
                  @keyup.enter.native="initFun" />
      ...
      <el-table v-if="tableData.length"
        ...
        <el-table-column prop="acceptor"
                         label="接受人姓名" />
        <el-table-column prop="runDatetime"
                         label="约跑日期">
        </el-table-column>
        <el-table-column prop="runLocation"
                         label="约跑地点" />
